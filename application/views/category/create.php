<div class="container">
    ...
    <div class="row">
        <div class="col-lg-10 col-sm-6">
          <h1 class="my-4"> <small> Create New Category </small>
          </h1>
        </div>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-lg-8 col-sm-6">
							<input type="text" class="form-control" id="category_name" placeholder="Enter Category Name" name="name" value="<?php echo set_value('name'); ?>">
