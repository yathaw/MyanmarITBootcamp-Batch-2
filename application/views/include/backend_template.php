  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item <?php if($this->uri->segment(1)=="author"){echo "active";}?>"">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> <?php echo $navbar; ?> </li>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function()
      {
        ...
        $('#newprofilediv').hide(); //div

        $("#old").click(function() // radio
        {
          $('#newprofilediv').hide(); // div
          $('#oldprofilediv').show(); // div
        });

        $("#new").click(function() // radio
        {
          $('#newprofilediv').show(); // div
          $('#oldprofilediv').hide(); // div
        });
      });
    
      $('#summernote').summernote({
        placeholder: 'Enter Biography of Author ',
        tabsize: 2,
        height: 100
      });
